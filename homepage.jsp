		...
		<div class="container">
			<div class="banner_top">
				...
				<div class="logo wow fadeInLeft animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
                                    <h1><a href="homepage.jsp" style="font-size:45px;"><span>C</span>ar For You..!</a></h1>
				</div>
                            <!--button-->
                              <div align="right">
                                 <!-- <button class="btn btn-default" ><a href="#loginform" data-toggle="modal" data-dismiss="modal"><b>Login/Register</b></a></button>-->
				...
				<!-- Collect the nav links, forms, and other content for toggling -->
                                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1" style="margin:auto;">
                                    <ul class="nav navbar-nav cl-effect-14" >
                                        ...
                                        <li><a href="contact.jsp"><b>Contact Us</b></a></li>
                                                ...
                                                %> 
                                                <div class="user_login" style="float:right; background-color:#00e0c3; margin:auto;">
                                                    <ul>
			...
			<div class="callbacks_container">
							    ...
							    <h2> <span>Fast cars are my only vice.</span> </h2>
							</div>		
        					</li>
						<li>
							<div class="slider-info">
                                                            <h2> <span>Cars bring me sheer joy.</span> </h2>
						    </div>
						</li>
						<li>
