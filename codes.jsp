			...
			<div class="banner_top">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav cl-effect-14">
                                        ...
                                        <li><a href="codes.jsp" class="active"><b>Codes</b></a></li>
...
<div class="page agile-1">
  ...
  <!--buttons-->
	<div class="page-header wthree-7">
        <h3>Buttons</h3>
      </div>
      <p class="grid1">
      ...
      <!--//alerts-->
        <!--nav-->
       <div class="page-header w3agile-7">
        <h3>Navs</h3>
